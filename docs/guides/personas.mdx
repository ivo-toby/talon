...
A persona is Talon's runtime identity for an agent: system prompt, optional provider override, model, skills, sub-agents, capability labels, and optional concurrency limits.
