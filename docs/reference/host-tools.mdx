...
| `memory-retriever` | `claude-haiku-4-5-20251001` | Retrieve relevant memory items for a query |
| `memory-groomer` | `claude-haiku-4-5-20251001` | Consolidate and prune memory entries |
| `file-searcher` | `claude-haiku-4-5-20251001` | Search files and return ranked snippets |
