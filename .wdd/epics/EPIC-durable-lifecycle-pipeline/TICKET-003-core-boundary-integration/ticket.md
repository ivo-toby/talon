...
|------|--------|------|---------|
| TASK-007-daemon-message-queue-schedule-events | todo | WAVE-004 | Construct/supervise lifecycle services and publish message, routing, queue, and schedule events while enforcing message.before_persist without disabled-behavior drift. |
